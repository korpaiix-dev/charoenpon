...
PACKAGES = [
    {
        "tier": "300",
        "name": "🥉 แพ็กเกจ 300 บาท",
        "price": "300",
        "duration": "30 วัน",
        "groups": ["ห้อง G300"],
        "details": (
            "เหมาะสำหรับผู้เริ่มต้น\n"
            "• เข้าห้อง G300 สัญญาณพื้นฐาน\n"
            "• อัปเดตข่าวสารรายวัน\n"
            "• ระยะเวลา 30 วัน"
        ),
    },
    {
        "tier": "500",
        "name": "🥈 แพ็กเกจ 500 บาท",
        "price": "500",
        "duration": "30 วัน",
        "groups": ["ห้อง G300", "ห้อง G500"],
        "details": (
            "สัญญาณคุณภาพคุ้มค่า\n"
            "• เข้าห้อง G300 + G500\n"
            "• สัญญาณ VIP เพิ่มเติม\n"
            "• วิเคราะห์เชิงลึก\n"
            "• ระยะเวลา 30 วัน"
        ),
    },
    {
        "tier": "1299",
        "name": "🥇 แพ็กเกจ 1,299 บาท",
        "price": "1,299",
        "duration": "30 วัน",
        "groups": ["ห้อง G300", "ห้อง G500", "ห้อง SSS", "ห้อง VGOD"],
        "details": (
            "แพ็กเกจยอดนิยม!\n"
            "• เข้าได้ 4 ห้อง: G300, G500, SSS, VGOD\n"
            "• สัญญาณ Premium ทุกตลาด\n"
    ...
    },
    {
        ...
        "details": (
            "แพ็กเกจสูงสุด - เข้าได้ทุกห้อง!\n"
            "• เข้าได้ทั้ง 7 ห้อง\n"
            "• สัญญาณ VIP ระดับสูงสุด\n"
            "• เข้าห้อง OF, INTER, SERIES พิเศษ\n"
            "• สิทธิพิเศษจากแอดมิน\n"
            "• ระยะเวลา 30 วัน"
        ),
    },
...
async def buy_package_callback(
    ...
    text = (
        ...
        f"📌 <b>วิธีชำระเงิน:</b>\n"
        f"1️⃣ โอนเงินตามยอดที่แจ้ง\n"
        f"2️⃣ ส่งสลิปโอนเงิน หรือ ลิงก์ซอง TrueMoney\n"
        f"3️⃣ รอระบบตรวจสอบ (ไม่เกิน 5 นาที)\n\n"
        f"💳 <b>ช่องทางชำระ:</b>\n"
        ...
        f"ห้ามโอนยอดอื่น ระบบจะตรวจสอบอัตโนมัติค่ะ"
    )
